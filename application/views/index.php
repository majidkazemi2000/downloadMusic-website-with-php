    ...
    <script>
        $(document).ready(function () {
            ...
            $("#search_text").keyup(function () {
                ...
                if (search.length >=2){
                    $("#close_search_div").attr("src","../static/images/load.gif")


                    $.ajax({
                        type:'POST',
                        url:'../ajax/searchmusic/',
                        data:{'searchtext':search},
                        success:function (response) {
                            $("#close_search_div").attr("src","../static/images/close.png")
                            if (response == false){
...
<body style="margin: 0px;padding: 0px;background: linear-gradient(#ecf0f1,#bdc3c7,#95a5a6);">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;padding: 0px;padding-top: 10px;padding-bottom: 10px;background-image: url('static/images/background.jpg');background-size: cover;background-repeat: no-repeat;background-position: top;">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;">
        <div class="col-lg-3 col-md-3 hidden-sm hidden-xs text-center" style="height: auto;padding: 0px;padding-top: 40px;padding-bottom: 80px;margin-bottom: 130px;">
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 text-center" style="height: auto;padding-top: 30px;padding-bottom: 30px;margin-top: 30px;">
            <?php
                if (isset($all_song) && $all_song != false){
                    foreach ($all_song as $val):
            ?>
            <div class="col-lg-6 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1 col-xs-12 text-center" style="height: auto;margin-bottom: 10px;margin-top: 10px;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;padding: 0px;position: relative;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2);background:linear-gradient(white,lightgray);">
                    <div class="text-center favorite" href="<?php echo $val['id'];?>" style="width: 50px;height: 50px;position: absolute;top: 5px;right: 10px;z-index: 20000;border-radius: 5px;cursor: pointer;border-radius: 50%;">
                        <img src="../static/images/star(1).png" style="height: 30px;width: 30px;margin-top: 10px;">
                    </div>

                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-left" style="height: 50px;padding: 0px;padding-left: 20px;">
                        <img src="../static/images/event.png" style="width: 20px;height: 20px;display: inline;margin-top: -2px;">
                        <p style="font-family: 'B Yekan';font-size: 13px;line-height: 50px;color: black;display: inline;margin-left: 5px;"><?php echo $val['date'];?></p>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right" style="height: 50px;">
                        <p style="padding:0px;line-height: 50px;font-family: 'B Yekan';color: black;font-size: 14px;">دانلود آهنگ <span style="color: black;"><?php echo $val['singer'];?></span> به نام <span style="color: black;"><?php echo $val['name'];?></span> <span style="color: black;">( <?php echo $val['category'];?> )</span></p>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 40px;position: absolute;top: 300px;left: 0px;z-index: 10000;">
                        <a href="../track/index/<?php echo $val['id'];?>" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center download btn1">دانلود و ادامه مطلب</a>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 250px;background-image: url('static/images/not-found.png');background-repeat: no-repeat;background-size: cover;background-position: center;padding: 0px;">
                    <img src="<?php echo $val['img'];?>" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 250px;padding: 0px;">
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 40px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2);background:linear-gradient(lightgray,white);">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center" style="height: 40px;padding: 0px;">
                        <p style="display: inline;font-family: 'B Yekan';color: black;line-height: 40px;"><?php echo $val['comment_count'];?></p>
                        <img src="../static/images/comment1.png" style="height: 20px;width: 20px;display: inline;">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center" style="height: 40px;padding: 0px;">
                        <p style="display: inline;font-family: 'B Yekan';color: black;line-height: 40px;"><?php echo $val['like_count'];?></p>
                        <img src="../static/images/heart1.png" style="height: 20px;width: 20px;display: inline;">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center" style="height: 40px;padding: 0px;">
                        <p style="display: inline;font-family: 'B Yekan';color: black;line-height: 40px;"><?php echo $val['visit_count'];?></p>
            ...
            ?>
                    ...
                    <div class="col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 300px;padding: 0px;box-shadow: 0 8px 16px 0px rgba(0,0,0,1);margin-bottom: 10px;margin-top: 10px;background-image: url('../static/images/error.png');background-size: cover;background-position: bottom;">
                        <p style="line-height: 300px;font-family: 'B Yekan';font-size: 20px;color: white;">آهنگی وجود ندارد</p>
                    </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="padding:0px;height: auto;padding-top: 15px;padding-bottom: 15px;margin-top: 30px;display: <?php if ($pages == 1 || $pages == false){echo 'none';}else{echo '';}?>;">
                <p style="font-family: 'B Yekan';font-size: 15px;color: white;">برو به صفحه</p>
               <?php
                    if (isset($pages) && $pages != false){
                        for ($i=$pages ; $i >= 1 ; $i--){
               ?>
                            <a href="?page=<?php echo $i;?>" style="padding: 5px 10px;background-color: #00CCFF;color: white;outline: none;border-radius: 5px;"><?php echo $i;?></a>
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 text-center" style="height: auto;padding: 0px;padding-top: 40px;padding-bottom: 40px;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: black;padding-top: 10px;padding-bottom: 10px;">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center item_side_main" style="padding: 0px;margin-top: 5px;margin-bottom: 5px;">
                    <a href="?cat=<?php echo $val['persian_name'];?>" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center category"><?php echo $val['persian_name'];?></a>
                </div>
                <?php
                        endforeach;
                    }else{
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 0;position: fixed;bottom: 0px;padding: 0px;z-index: 5000000;" id="success_add_favorite">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 60px;padding:0px;background-color: transparent;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="background-color: #4ccb5e;">
                <p style="line-height: 60px;font-family: 'B Yekan';font-size: 20px;color: white;">آهنگ مورد نظر به لیست علاقه مندی ها اضافه شد</p>
            </div>
        </div>
    </div>
