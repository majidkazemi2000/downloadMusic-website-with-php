...
<body style="margin: 0px;padding: 0px;background: linear-gradient(#ecf0f1,#bdc3c7,#95a5a6);">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;">
        <div class="col-lg-3 col-md-3 hidden-sm hidden-xs text-center" style="height: auto;padding: 0px;padding-top: 40px;padding-bottom: 80px;margin-bottom: 150px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 50px;background-color: lightgray;padding: 0px;">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: black;padding-top: 5px;padding-bottom: 5px;" id="new_div1">
                    <?php
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: black;padding-top: 5px;padding-bottom: 5px;display:none;" id="popular_div1">
                    <?php
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: black;padding-top: 5px;padding-bottom: 5px;display:none;" id="view_div1">
                    <?php
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 text-center" style="height: auto;padding-top: 20px;padding-bottom: 40px;margin-top: 30px;">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 text-center" style="height: 200px;margin-top: 15px;margin-bottom: 15px;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center icon_info" href="<?php echo $val['id'];?>" style="background-color: lightgray;height: 190px;margin-top: 5px;background-image: url('../../static/images/not-found.png');background-size: cover;background-position: center;background-repeat: no-repeat;padding: 0px;position: relative;box-shadow: 0 8px 16px 0px rgba(0,0,0,1)">
                    <img src="<?php echo $val['img'];?>" style="width: 100%;height: 190px;z-index: 10000;">
                    <p style="width: 80%;height: 40px;font-family: 'B Yekan';line-height: 40px;background-color: lightgray;position: absolute;bottom: -30px;left: 25px;color: black;padding: 0px;transform: skew(-12deg);border-radius: 20px 0px 20px 0px;"><?php echo $val['name'];?></p>
                </div>
            </div>
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 text-center" style="height: auto;padding: 0px;padding-top: 40px;padding-bottom: 40px;margin-top: 0px;">
            <div class="hidden-lg hidden-md col-sm-12 col-xs-12 text-center" style="height: auto;padding: 0px;padding-top: 40px;margin-bottom: 20px;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: lightgray;padding: 0px;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: lightgray;padding-top: 5px;padding-bottom: 5px;" id="new_div">
                        <?php
                        if (isset($new_song) && $new_song != false){
                            foreach ($new_song as $val):
                                ?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: lightgray;padding-top: 5px;padding-bottom: 5px;display:none;" id="popular_div">
                        <?php
                        if (isset($like_song) && $like_song != false){
                            foreach ($like_song as $val):
                                ?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: lightgray;padding-top: 5px;padding-bottom: 5px;display:none;" id="view_div">
                        <?php
                        if (isset($visit_song) && $visit_song != false){
                            foreach ($visit_song as $val):
                                ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="background-color: rgba(1,1,1,.95);position: fixed;top: 0px;right: 0px;left: 0px;bottom: 0px;z-index: 30000000;display: none;overflow-y: scroll;" id="info_div">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-left" style="height: 40px;margin-top: 20px;">
            <img src="../../static/images/close.png" style="height: 40px;width: 40px;cursor: pointer;" id="close_info_div">
        </div>
        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 text-center" style="height: 100px;background-color: red;display: none;border-radius: 10px;margin-top: 100px;">
            <p style="line-height: 100px;color: white;font-family: 'B Yekan';font-size: 20px;" id="error_info">اطلاعاتی یافت نشد</p>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;background-color: lightgray;margin-top: 40px;padding-top: 20px;padding-bottom: 20px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right" style="height: auto;padding-top: 20px;padding-bottom: 20px;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;padding-top: 60px;padding-bottom: 2px;position: relative;">
                    <p style="direction: rtl;font-family: 'B Yekan';font-size: 15px;" id="text_about"></p>
                    <img src="../../static/images/not-found.png" style="height: 150px;width: 150px;border-radius: 50%;position: absolute;top: -120px;right: 40px;" id="img_info">
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: 60px;padding: 0px;border-bottom: solid 2px black;">
                <p style="font-family: 'B Yekan';font-weight: bold;font-size: 20px;line-height: 60px;">لیست آهنگ ها</p>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="height: auto;padding: 0px;padding-top: 20px;padding-bottom: 20px;" id="song_box">
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="padding:0;height: 50px;background-color: red;display: none;border-radius: 10px;margin-top: -20px;" id="error_song">
                <p style="line-height: 50px;font-family: 'B Yekan';color: white;font-size: 20px;">آهنگی وجود ندارد</p>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function () {
        ...
        $(".icon_info").click(function () {
            ...
            $.ajax({
                ...
                success:function (response) {
                    ...
                    if (response != false){
                        ...
                        var textabout=s[0]
                        var img=s[1]
                        $("#text_about").text(textabout)
                        $("#img_info").attr("src",img)
                    }else{
                       $("#error_info").show()
                    }
            ...
            $.ajax({
                type:'POST',
                data:{'id':id},
                url:'../../ajax/getsongforsinger/',
                success:function (response) {
                    if (response != false){
                        $("#error_song").hide()
                        $("#song_box").html(response)
                    }else{
                        $("#song_box").html("")
                        $("#error_song").show('blind')
                    }
